...
- Panel OpenCV compacto, centrado y responsivo con reparto horizontal 38/62 para
  cámara e imagen, secciones de igual altura, etiqueta y porcentaje de similitud.
